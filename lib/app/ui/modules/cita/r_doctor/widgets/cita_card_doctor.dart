...
import 'package:admin_clinica_front/app/ui/modules/cita/bloc/cita_hora_bloc/cita_hora_bloc.dart';
...
class CitasCardDoctor extends StatelessWidget {
  final CitasViewModel cita;

  const CitasCardDoctor({super.key, required this.cita});
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: stt.cita.map((cita) => CitasCardDoctor(cita: cita)).toList(),
                          ),
                        ],
                      ),
                    );
