...
import 'package:admin_clinica_front/app/modules/doctor/bloc/doctor_index_bloc/doctor_index_bloc.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class DoctorAsistenteDoctorCard extends StatelessWidget {
  final DoctorDto doctor;
  final Function(int)? onUpdate;

  const DoctorAsistenteDoctorCard({
    super.key,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        AppTextGlobal.labelLightText(text: "USERss  NAME:", fontSize: 13),
                                        AppBox.w4,
