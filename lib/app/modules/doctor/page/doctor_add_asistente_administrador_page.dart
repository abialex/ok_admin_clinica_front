...
import 'package:admin_clinica_front/app/modules/doctor/bloc/doctor_create_bloc.dart';
import 'package:admin_clinica_front/app/modules/doctor/bloc/doctor_list_bloc.dart';
import 'package:admin_clinica_front/app/modules/doctor/model/doctor_create_form.dart';
...
class DoctorAddAsistenteAdministradorPage extends StatelessWidget with ResponsiveWidgetMixin {
  DoctorAddAsistenteAdministradorPage({super.key});

  final formKey = GlobalKey<FormState>();
  DoctorCreateForm muDoctor = DoctorCreateForm(
    dni: "",
    nombres: "",
    apellidos: "",
    celular: "",
