...
import 'package:admin_clinica_front/app/modules/doctor/widget/doctor_asistente_doctor_card.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class DoctorListAsistenteDoctorPage extends StatelessWidget with ResponsiveWidgetMixin {
  const DoctorListAsistenteDoctorPage({super.key});
                ...
                doctorsLoaded: (stt) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = stt.doctors[index];
                      return DoctorAsistenteDoctorCard(
                          onUpdate: (doctorId) {
