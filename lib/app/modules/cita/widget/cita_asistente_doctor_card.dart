...
class CitaAsistenteDoctorCard extends StatelessWidget {
  final CitaDTO cita;

  const CitaAsistenteDoctorCard({super.key, required this.cita});
...
class CitasGroupedByHourAsistAsist extends StatelessWidget {
  ...
  const CitasGroupedByHourAsistAsist({
    super.key,
    required this.citas,
    this.onAdd,
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: stt.cita.map((cita) => CitaAsistenteDoctorCard(cita: cita)).toList(),
                          ),
                        ],
                      ),
                    );
